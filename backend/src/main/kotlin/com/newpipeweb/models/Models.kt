...
@Serializable
data class CombinedExportEnvelope(
    val schemaVersion: Int = 1,
...
@Serializable
data class CombinedImportSummary(
    val subscriptions: SubscriptionImportSummary = SubscriptionImportSummary(0, 0),
    val playlists: CategoryImportSummary = CategoryImportSummary(),
    val history: CategoryImportSummary = CategoryImportSummary(),
    val watchlist: CategoryImportSummary = CategoryImportSummary()
)
